...
- (void)viewDidLoad {
    ...
    if (!_selectToSend) {
        ...
        self.navigationItem.leftBarButtonItem = [UIBarButtonItem itemWithIcon:@"common_icon_navigaiton_back_highlight" highIcon:nil target:self action:@selector(goBack)];
    } else {
