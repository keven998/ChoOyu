...
#define BASE_URL1                                @ "http://api2.taozilvxing.cn/taozi/"
#define BASE_URL                                 @ "http://182.92.150.243:9000/taozi/"
//攻略相关接口
...
#define API_POST_PHOTOALBUM                     (BASE_URL @"misc/put-policy/album")  //上传相册接口
