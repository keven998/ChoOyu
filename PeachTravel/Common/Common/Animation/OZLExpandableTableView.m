...
- (void)expandFromCell:(UIView *)sourceView
    ...
    CGRect upperRect = CGRectMake(0, 110, 320, sep);
    CGRect bottomRect = CGRectMake(0, 110 + sep, 320, self.view.frame.size.height - sep);
    ...
    [whiteView setBackgroundColor:APP_PAGE_COLOR];
    [whiteView setTag:WHITEVIEW_TAG];
    [self.view addSubview:whiteView];
    
    [viewController.view setTag:WHITEVIEW_TAG];
    viewController.view.frame = CGRectMake(0, 114 + sep, 320, 600);
...
//                         [viewController.view setFrame:CGRectMake(0, 44, upperRect.size.width, 600)];
