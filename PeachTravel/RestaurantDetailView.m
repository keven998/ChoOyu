...
- (void)setupSubView
{
    ...
    [self registerNib:[UINib nibWithNibName:@"RestaurantLocationTableViewCell" bundle:nil] forCellReuseIdentifier:locationCellIdentifier];
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 2) {
        ...
        NSInteger lineCount = (size.width / (self.frame.size.width-20)) + 1;
...
{
    if (indexPath.section == 0) {
        RestaurantLocationTableViewCell *locationCell = [tableView dequeueReusableCellWithIdentifier:locationCellIdentifier];
