...
{
	[sender setBackgroundColor:(__bridge CGColorRef)([UIColor colorWithRed:94/255.0 green:196/255.0 blue:221/255.0 alpha:1.0])];
}

- (void)clearBackgroundColorForButton:(id)sender
{
	[sender setBackgroundColor:(__bridge CGColorRef)([UIColor clearColor])];
}
