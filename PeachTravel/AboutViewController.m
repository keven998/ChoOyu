...
- (void)viewDidLoad
{
    ...
    title.font = [UIFont fontWithName:@"MicrosoftYaHei" size:20.0];
    ...
    title1.font = [UIFont fontWithName:@"MicrosoftYaHei" size:18.0];
    ...
    net.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    weichat.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    weibo.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    email.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    qq.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    about.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    version.font = [UIFont fontWithName:@"MicrosoftYaHei" size:13.];
    ...
    right.font = [UIFont fontWithName:@"MicrosoftYaHei" size:9.];
