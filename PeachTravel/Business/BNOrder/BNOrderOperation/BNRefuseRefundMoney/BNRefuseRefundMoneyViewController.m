//
//  BNRefuseRefundMoneyViewController.m
//  PeachTravel
//
...
@interface BNRefuseRefundMoneyViewController () <UITableViewDataSource, UITableViewDelegate, UITextViewDelegate> {
    NSTimer *timer;
}
...
- (void)setupToolBar
{
    ...
    [confirmRefundButton setTitle:@"拒绝退款" forState:UIControlStateNormal];
    ...
    [confirmRefundButton addTarget:self action:@selector(confirmRefuseRefundMoney:) forControlEvents:UIControlEventTouchUpInside];
