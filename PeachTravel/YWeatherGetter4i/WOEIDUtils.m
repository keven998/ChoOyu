...
- (void) querWOEID:(double)latitude longitude:(double)longitude yahooAPIKey:(NSString *)yahooAPIKey;
{
    NSString* woeidRequestUrl = @"http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20geo.placefinder%20where%20text%3D";
    NSMutableString *urlStr = [[NSMutableString alloc] initWithUTF8String:[woeidRequestUrl UTF8String]];
    
    [urlStr appendString:@"%22"];
    [urlStr appendString:[NSString stringWithFormat:@"%f", latitude]];
    [urlStr appendString:@"%2C"];
    [urlStr appendString:[NSString stringWithFormat:@"%f", longitude]];
    [urlStr appendString:@"%22"];
    [urlStr appendString:@"%20and%20gflags%3D%22R%22"];
