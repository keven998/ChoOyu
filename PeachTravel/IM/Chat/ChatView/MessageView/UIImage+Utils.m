...
- (UIImage *) maskWithImage:(const UIImage *) maskImage
{
    ...
    const CGContextRef mainViewContentContext = CGBitmapContextCreate (NULL, maskImage.size.width, maskImage.size.height, 8, 0, colorSpace, bitmapInfo);
...
- (UIImage *) maskWithColor:(UIColor *) color
{
    ...
    int bitmapInfo = kCGBitmapByteOrderDefault | kCGImageAlphaPremultipliedLast;
    CGContextRef bitmapContext = CGBitmapContextCreate(NULL, width, height, 8, 0, colorSpace, bitmapInfo);
